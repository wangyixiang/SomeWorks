...
def main(args):
    ...
    queryset_path = r"D:\datasets\xxxx_data\testphoto(simple)\query_photo_folder_clean"
    dataset_path = r"D:\datasets\xxxx_data\testphoto(simple)\id_photo_folder_clean"

    dlib_generate_result(get_q_list(queryset_path), get_d_list(dataset_path), {})
